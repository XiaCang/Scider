...
const steps: OnboardStep[] = [
  ...
  },
  {
    ...
    description:
      'PDF 场景：在阅读界面打开 AI 对话侧栏，基于当前论文内容流式问答。图谱场景：点击工具栏「AI 对话」按钮一键开关侧栏（再次点击关闭），侧栏宽度可自由拖拽调整，基于当前图谱所有论文节点提问。均采用 RAG 技术确保回答贴合论文原文。',
  ...
  },
  {
    ...
    description:
      '选择文件夹后，LLM 自动分析论文并生成力导向图，节点按研究主题自动聚类着色。支持拖拽缩放、手动编辑图谱、点击节点查看详情。内嵌 AI 对话侧栏，可一键开关并拖拽调整宽度，基于图谱论文节点智能问答。支持导出 PNG/SVG。',
